...
- [Matplotlib for Data Visualization](https://matplotlib.org/stable/contents.html)
- [OpenWeather API](https://openweathermap.org/api) (for Weather App)

Let me know when you're ready to resume work on your current project or start the next one!
